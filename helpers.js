import { POLLINATIONS_API_KEY, POLLINATIONS_MODEL, HISTORY_LEN, FINNHUB_API_KEY } from "./config.js";
...
// Pulls one real quote from Finnhub's free /quote endpoint.
// Returns the current price (number), or null if the key isn't set / call fails.
export async function fetchRealQuote(ticker) {
